...
if(isset($_POST['update_payment'])){
   ...
   $message[] = 'Актуализиран статус на плащане!';
}
...
<div class="box-container">
   ...
   <div class="box">
      ...
      <p> Метод на плащане : <span><?= $fetch_orders['method']; ?></span> </p> 
      <form action="" method="post">
        ...
        <div class="flex-btn">
         <input type="submit" value="Обновете" class="option-btn" name="update_payment">
         <a href="placed_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('delete this order?');">Изтрийте</a>
        </div>
      </form>
   </div>
   <?php
