...
<section class="products">
    ...
    <h1 class="heading"> <span> ОХЛАДИТЕЛИ </span> </h1>

    <div class="box-container">

        <?php
                $select_products = $conn->prepare("SELECT * FROM `coolers` LIMIT 6"); 
        ...
        <form action="" method="post" class="box" >
            ...
            <div class="image">
             ...
             <div class="icons">
              ...
              <a href="quick_view_coolers.php?pid=<?= $fetch_product['id']; ?>" class="fas fa-eye"></a>
             </div>
