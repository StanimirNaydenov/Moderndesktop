...
<section class="products">
    ...
    <h1 class="heading"> <span>МИШКИ</span> </h1>

    <div class="box-container">
        
        <?php
                $select_products = $conn->prepare("SELECT * FROM `mouse` LIMIT 6"); 
        ...
        <form action="" method="post" class="box" >
            ...
            <div class="image">
             ...
             <div class="icons">
              ...
              <a href="quick_view_mouse.php?pid=<?= $fetch_product['id']; ?>" class="fas fa-eye"></a>
             </div>
