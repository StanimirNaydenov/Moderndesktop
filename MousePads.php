...
<head>
    ...
    <title>Плодложки за мишки</title>
...
<section class="products">
    ...
    <h1 class="heading">Плодложки за   <span> мишки</span> </h1>

    <div class="box-container">
            <?php
                $select_products = $conn->prepare("SELECT * FROM `mousepads` LIMIT 6"); 
        ...
        <form action="" method="post" class="box" >
            ...
            <div class="image">
             ...
             <div class="icons">
              ...
              <a href="quick_view_mousepads.php?pid=<?= $fetch_product['id']; ?>" class="fas fa-eye"></a>
             </div>
             ...
             <input type="submit" value="Дабавете в количката" class="btn" name="add_to_cart">
