...
<?php include 'components/user_header_search.php'; ?>

<!-- products section starts  -->

<section class="search-form">
   <form action="" method="post">
      <input type="text" name="search_box" placeholder="Търсете тук..." maxlength="100" class="box" required>
...
<section class="products" style="padding-top: 0; min-height:100vh;">
   ...
   <?php
         ...
         echo '<p class="empty">Няма немерини продукти!</p>';
      }
   }
   ?>
   </div>
